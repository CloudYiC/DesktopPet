...
(async () => {
  ...
  try {
    ...
    console.log('PASS software uninstall UI: five-row pagination, filters, fixed detail, internal inventory scrolling, path reveal, frozen named cleanup confirmation, failed cleanup feedback, post-uninstall cached plan, scan cancellation and late-response isolation. Synthetic calls only.');
