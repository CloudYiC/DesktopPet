...
- 0.13.17 精简桌面依依：点击显示“打开工具台 / 我的理财 / 个人学习”，齿轮直达网站设置；两个网站地址可自行填写并通过默认浏览器打开，不预置或自动访问任何网站
...
```text
out/dist/CloudYiAssistant-Setup-0.13.17.exe
```
...
把单个 `CloudYiAssistant-Setup-0.13.17.exe` 通过 U 盘复制到 Windows 10/11 x64 电脑并双击，
