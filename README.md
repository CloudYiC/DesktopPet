...
- 新增独立桌面“发包工具”：TCP/UDP、文本/HEX/转义字节、二进制文件载入、常用报文库导入导出、有限次数重发和响应记录；左侧编辑、右侧报文库与彩色收发日志，不在独立网页端提供通信
...
```text
out/dist/CloudYiAssistant-Setup-0.13.6.exe
```
...
把 `CloudYiAssistant-Setup-0.13.6.exe` 复制到 Windows 10/11 x64 电脑并双击，
